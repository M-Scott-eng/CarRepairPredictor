...
export default function SignupPage() {
  ...
  const onSubmit = async (data: SignupFormData) => {
    ...
    try {
      ...
      // On success, redirect to predict page
      navigate('/predict')
    } catch (err) {
  ...
  return (
    <div className="min-h-[calc(100vh-200px)] bg-gray-50 flex items-center justify-center py-12 px-4 fade-in">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2">
            ...
            <span className="text-2xl font-bold text-gray-900">RepairPredictor</span>
          </Link>
        </div>
        ...
        <Card className="p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">Get started with 3 free predictions</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            {errors.acceptTerms && (
              <p className="text-sm text-red-600 -mt-3">{errors.acceptTerms.message}</p>
            )}
